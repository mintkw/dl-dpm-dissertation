...
#     print(ae_seq_prediction_train)
#     print("AE sequence score:", evaluate_sequence(ae_seq_prediction_train.cpu(), seq_gt))
#
...
#     sigmoid_params_train, fig_train, ax_train = fit_biomarker_curves(train_loader, ae, n_epochs=500, device=DEVICE, lr=0.01)
#     label = fig_train._suptitle.get_text()
#     fig_train.suptitle(label + " on training set")
#     fig_train.show()
#     print(sigmoid_params_train)
#
#     sigmoid_params_val, fig_val, ax_val = fit_biomarker_curves(val_loader, ae, n_epochs=500, device=DEVICE, lr=0.01)
#     label = fig_val._suptitle.get_text()
#     fig_val.suptitle(label + " on validation set")
#     fig_val.show()
#     print(sigmoid_params_val)
#
