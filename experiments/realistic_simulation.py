...
if __name__ == "__main__":
    ...
    for trial in range(n_trials):
        ...
        simulate_data.generate_data(n_biomarkers=n_biomarkers, n_mci=n_mci, n_controls=n_controls,
    ...
    for i in range(len(model_types)):
        ...
        print(
            f"Sequence Kendall's tau score of {model_types[i]}: {sequence_scores[i].mean()} +- {sequence_scores[i].std()}")
        print()
