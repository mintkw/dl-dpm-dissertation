...
if __name__ == "__main__":
    ...
    n_biomarkers_all = [i for i in range(25, 505, 25)]
    ...
    with open('dataset_size_comparison_results.csv', 'w', newline='') as output_f:
        ...
        writer.writerow(['vae_time', 'ae_time', 'vae_reconstruction', 'ae_reconstruction'])
        ...
        for i in range(len(dataset_names)):
            ...
            print(f"Now training on dataset with {n_biomarkers} biomarkers")
            ...
            reconstruction_errors_vae.append(reconstruction_mse)
            ...
            reconstruction_mse = reconstruction_mse.cpu()
            reconstruction_errors_ae.append(reconstruction_mse)
    ...
    fig.suptitle("Time taken to fit model")
